...
const MenuItem: React.FC<MenuItemProps> = ({ 
  ...
  return (
    <button
      onClick={() => onClick(id)}
      className={`w-full px-4 py-3 rounded-lg transition-all flex items-center group ${
        isActive 
          ? 'bg-primary-100 text-primary-800 font-medium shadow-sm' 
          : 'text-neutral-700 hover:bg-neutral-100'
      }`}
    >
      <span className={`inline-flex mr-3 ${isActive ? 'text-primary-600' : 'text-neutral-500 group-hover:text-neutral-700'}`}>
        {icon || defaultIcon()}
      </span>
