  ...
  theme: {
    extend: {
      colors: {
        ...
        // Secondary colors for accents and UI elements
        secondary: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Danger colors for errors/destructive actions
        danger: {
          50: '#fef2f2',
          100: '#fee2e2',
          200: '#fecaca',
      ...
      fontFamily: {
        ...
        heading: ['Poppins', 'sans-serif'], // Good font for headings in a profile matching app
      },
      borderRadius: {
